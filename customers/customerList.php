...
if($result = mysqli_query($dbhandle,$sql)){
	...
	echo "</tr>";
        while($row = mysqli_fetch_array($result)){
				...
				echo "<td><center><label>".$row['GSTTREATMENT']."</label></center></td>";
                
				
				
				echo "<td><center><label>" . $row['GSTN'] . "</label></center></td>";
        ...
        echo "</table>";
			...
			echo "</br><script src='/$nitinTraders/js/pushy.min.js'></script>";
			echo "</div></body>";
        // Close result set
