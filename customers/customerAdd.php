...
@media screen and (min-width: 480px) {
  ...
  form {
	...
	?>
      <form action="customerAddSubmit.php" enctype="multipart/form-data" method="post">
	...
	?>
			<label id="GSTNLABEL" style="display:none;" >GST NUMBER </label>
			<input type="text" id="GSTN" name="GSTN" style="display:none;" >	
	</fieldset>
