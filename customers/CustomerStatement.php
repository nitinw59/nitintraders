  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			var server_root=<?php echo json_encode($nitinTraders);?>;
				...
				$("#showBills").click(function(){
					...
					$.ajax({
						...
						$("#bills_tbl").append(markup);
						 markup= "<tr><td ><center><button class='print'>Print</button></center></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
						$("#bills_tbl").append(markup);
...
@media screen and (min-width: 480px) {
  ...
  form {
	...
	<center><h3>Customer statement[cgst sgst igst banana hai]</h3></center>
