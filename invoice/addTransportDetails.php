			...
			$(document).ready(function() {
				...
				$("#bill_id_drop").change(function(){
                     ...
                     $.ajax({
                        ...
                        data:"bill_id="+bill_id+"&action=fetchTransportDetails",
				...
				$("#updateTransportDetails").click(function(){
					...
					if($('#file').get(0).files.length > 0 && bookingDateOk){
							...
							if(($('#file')[0].files[0].size)/1000 < 20000){
								...
								var fd = new FormData();
								fd.append('bill_id',$("#bill_id_drop").val());
								fd.append('LR_DATE',LR_DATE);
								fd.append('LR',LR);
								fd.append('LR_EWAY',LR_EWAY);
...
$current_date=date('Y-m-d', time());
	...
	EWAY<input type="number" id="LR_EWAY" name="LR_EWAY" value="0">
