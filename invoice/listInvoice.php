...
if($result = mysqli_query($dbhandle,$sql)){
	...
	if(mysqli_num_rows($result) > 0){
        ...
        echo "<body><div id='invoicelist'><table>";
            echo "<tr>";
				...
				echo "<th style='width:7%'>QUANTITY</th>";
				echo "<th style='width:7%'>RATE</th>";
				echo "<th>AMOUNT</th>";
				echo "<th>CGST</th>";
				echo "<th>SGST</th>";
				echo "<th>IGST</th>";
	...
	echo "</tr>";
        while($row = mysqli_fetch_array($result)){
                ...
                echo "<td><center>" . ($row['TOTAL_AMOUNT']+$row['CGST']+$row['SGST']+$row['IGST']) . "<center></td>";
                echo "<td><center><button type='submit' class='updateInvoice' value=".$row['BILL_ID'].">UPDATE/VIEW</button><center></td>";
				echo "<td><center><a href='showInvoice.php?bill_id=".$row['BILL_ID']."'>Invoice</a><center></td>";
