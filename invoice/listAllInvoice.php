...
<?php
  ...
  <head>
				...
				$("#showBills").click(function(){
					...
					$.ajax({
						...
						$.each(bills_list, function( index, bill ) {
							...
							var total_amount=Number(bill["TOTAL_AMOUNT"])+Number(bill["CGST"])+Number(bill["SGST"])+Number(bill["IGST"]);
							
							var markup= "<tr><td><center>"+bill["BILL_ID"]+"</center></td><td><center>"+bill["DATE"]+"</center></td><td><center>"+bill["COMPANY_NAME"]+"</center></td><td><center>"+bill["GSTN"]+"</center></td><td><center>"+bill["TOTAL_AMOUNT"]+"</center></td><td><center>"+bill["CGST"]+"</center></td><td><center>"+bill["SGST"]+"</center></td><td><center>"+bill["IGST"]+"</center></td><td><center>"+(total_amount)+"</center></td></tr>";
	...
	<center><h3>Monthly Bills</h3></center>
