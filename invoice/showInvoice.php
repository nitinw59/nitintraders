...
include($_SERVER['DOCUMENT_ROOT']."/htaccess.php");
 ...
 // Attempt select query execution
	...
	$sqlquery = "SELECT b.date,b.due_date,b.total_amount,c.fname,c.lname,c.company_name,c.mobile,c.gsttreatment,c.gstn,c.address,c.city,c.state,c.zip,c.mobile,t.transport_name,t.transport_parcels,t.lr,t.eway,t.date as t_date FROM bills_tbl b,customers_tbl c,transport_tbl t where b.customer_id=c.customer_id and b.bill_id=t.bill_id and b.bill_id='".$_GET["bill_id"]."' ORDER BY  b.bill_id DESC";
	...
	$BILL_DUE_DATE=date('d/m/Y', strtotime($row['due_date']));
...
<table style="width:100%"  align=center>
  ...
  <tr>
    ...
    <td>Invoice No.</br><b><?=($BILL_ID%1000)?></b></td>
  ...
  <tr>
    ...
    <td>LR No- <b><?=$BILL_LR?> - <?=$t_date?></b></td>
    <td>EWAY-<?=$BILL_EWAY?></td>
  </tr>
  <tr>
...
<table style="width:100%"  align=center id="items">
  ...
  $sqlquery="select  
					...
					bi.rate,
					bi.description
					from bill_items_tbl bi where bi.bill_id=".$BILL_ID.";";
  ...
  $show=mysqli_query($dbhandle,$sqlquery);
    ...
    echo "<td>code:".$row['items_id']." ".$row['description']."</td>";
	echo "<td>6203</td>";
