			...
			$(document).ready(function() {
				...
				$("#makepayment").click(function(){
					...
					$.ajax({
                        ...
                        data:"trans_date="+trans_date+"&trans_amount="+trans_amount+"&trans_description="+trans_description+"&action=addCashPayment",
...
include($_SERVER['DOCUMENT_ROOT']."$server_root/index.php");
	...
	<table>
	<tr><td>DATE </td><td><input type="date" id="trans_date" ></td></tr>
	<tr><td>AMOUNT </td><td><input type="number" id="trans_amount" name="trans_amount" ></td></tr>
	<tr><td>Remark </td><td><textarea id="trans_description" name="trans_description" rows="3" cols="50"></textarea></td></tr>
