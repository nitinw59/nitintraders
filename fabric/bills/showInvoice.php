...
<caption> TAX INVOICE </caption> 
 
  <tr>
    <td rowspan="3" colspan="2" cellpadding="10px"><?=$MY_COMPANY_NAME?></br><?=$MY_COMPANY_ADDR?></br><?php echo $MY_COMPANY_CITY."-".$MY_COMPANY_ZIP."</br>".$MY_COMPANY_STATE."(".$MY_COMPANY_STATE_CODE.")</br> MOB. ".$MY_COMPANY_MOB."</br>GSTN- ".$MY_COMPANY_GSTN;?></td>
  ...
  <tr>
    <td rowspan="4" colspan="2"><?php 
	if($COMPANY_GSTTREATMENT=='UNREGISTERED')
		$COMPANY_GSTN='N/A';
	
	
	echo $COMPANY_NAME.",</br>".chunk_split($COMPANY_ADDR,25,"</br>")."".$COMPANY_CITY."-".$COMPANY_ZIP."</br>".$COMPANY_STATE." (".$COMPANY_STATE_CODE.")</br> MOB. ".$COMPANY_MOB."</br>GSTN- ".$COMPANY_GSTN;?></td>
  ...
  <tr>
    ...
    <td>Destination: <?=$COMPANY_CITY?></td>
  </tr>
  <tr>
...
<table style="width:100%"  align=center id="items">
  ...
  <?php
  echo " state ".strcmp($COMPANY_STATE_CODE,$MY_COMPANY_STATE_CODE);
