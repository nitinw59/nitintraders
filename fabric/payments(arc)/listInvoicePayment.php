...
include($_SERVER['DOCUMENT_ROOT']."$nitinTraders/index.php");
	...
	$sqlquery="SELECT mb.MERCHANT_BILL_NUMBER, mp.date,mp.amount,mp.DESCRIPTION FROM merchant_payments_tbl mP, merchant_bills_tbl mb where mb.BILL_ID=MP.BILL_ID AND mP.BILL_ID=".$bill_id;
	...
	$show=mysqli_query($dbhandle,$sqlquery);
	  ...
	  while($row=mysqli_fetch_array($show)){
		...
		echo "<tr><td><center>".$row['date']."</center></td><td><center>".$row['amount']."</center></td><td><center>".$row['DESCRIPTION']."</center></td><td><center>".$row['MERCHANT_BILL_NUMBER']."</center></td></tr>";
